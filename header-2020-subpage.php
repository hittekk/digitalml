...
<head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Montserrat:300,400,500,500i,700,800" rel="stylesheet">
    ...
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/dist/css/style-october.css?cachebust=<?php echo rand();?>"/>
    <link rel="stylesheet" href="<?php echo get_template_directory_uri() ?>/dist/css/style-navigation.css?cachebust=<?php echo rand();?>"/>
...
<body class="with-hero <?=$post->post_name ?>">
	...
	<a href="/banking-payments/">Banking and Payments</a>
	<a href="/insurance-and-healthcare/">Insurance & Healthcare</a>
</div>
				</div>
			</div>
        </header>
