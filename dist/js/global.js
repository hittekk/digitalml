...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_slick_carousel__ = __webpack_require__(329);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__modules_header__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__modules_tabs__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__modules_slider__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__modules_cookie__ = __webpack_require__(335);
...
Object(__WEBPACK_IMPORTED_MODULE_2__libs_binder__["a" /* binder */])({
    bounds: {
        "html": __WEBPACK_IMPORTED_MODULE_3__modules_module__["a" /* constants */],
        ".js-header-menu": __WEBPACK_IMPORTED_MODULE_4__modules_header__["b" /* headerNavigation */],
        ".js-burger": __WEBPACK_IMPORTED_MODULE_4__modules_header__["a" /* burgerTrigger */],
        ".js-tabs-triggers": __WEBPACK_IMPORTED_MODULE_5__modules_tabs__["a" /* tabs */],
        ".js-slider": __WEBPACK_IMPORTED_MODULE_6__modules_slider__["a" /* slider */],
        ".js-subscribe-frame": __WEBPACK_IMPORTED_MODULE_3__modules_module__["b" /* iframeReload */],
        ".js-cookie": __WEBPACK_IMPORTED_MODULE_7__modules_cookie__["a" /* closeCookiePopup */]
    },
    runTests: false
});
...
/* harmony export (immutable) */ __webpack_exports__["b"] = iframeReload;
function _toConsumableArray(arr) { if (Array.isArray(arr)) { for (var i = 0, arr2 = Array(arr.length); i < arr.length; i++) { arr2[i] = arr[i]; } return arr2; } else { return Array.from(arr); } }
...
function iframeReload() {
    ...
    eventer(messageEvent, function (e) {
        if (e.data === "formIsSent" || e.message === "formIsSent") {
            setTimeout(function () {
                [].concat(_toConsumableArray(document.querySelectorAll(".js-subscribe-frame iframe"))).forEach(function (item) {
                    item.src = item.src;
                });
            }, 3000);
        }
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["b"] = headerNavigation;
/* harmony export (immutable) */ __webpack_exports__["a"] = burgerTrigger;
// init header navigation
function headerNavigation() {
    var _this = this;

    $(".js-header-menu").find(".menu-item-has-children > a").on("click", function (e) {
        var isTabletRes = window.innerWidth < _this.desktop;

        e.preventDefault();

        if (isTabletRes) {
            var $container = $(e.target).closest(".menu-item");
            var $content = $(e.target).siblings(".js-header-menu-content");

            $container.toggleClass("is-open").siblings(".menu-item").removeClass("is-open");

            $(".js-header-menu-content").not($content).slideUp();
            $content.slideToggle();
        }
    });
}
...
function burgerTrigger() {
    document.querySelector(".js-burger").addEventListener("click", function (e) {
        var burgerContainer = e.target.closest(".js-burger-container");
        var body = document.querySelector("body");

        burgerContainer.classList.toggle("is-open");
...
function tabs() {
    var $tabsTriggers = $(".js-tabs-triggers");

    $tabsTriggers.each(function (index, item) {
        var indexTab = $(item).find(".is-active").parent().index();
        $(item).siblings(".js-tabs-content").eq(indexTab).addClass("is-active");
    });

    $tabsTriggers.find("a").on("click", function (e) {
        e.preventDefault();

        var $self = $(this);
        var $container = $self.closest(".js-tabs-triggers");
        var $triggers = $container.find("a");
        var index = $self.parent().index();
        var $content = $container.siblings(".js-tabs-content");
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["a"] = slider;
function slider() {
    var options = {
        dots: false,
        arrows: true,
        draggable: false,
        nextArrow: "<button class='slick-next slick-arrow'><svg class='slick-arrow-icon'><use xlink:href='#arrow-right'></use></svg></button>",
        prevArrow: "<button class='slick-prev slick-arrow'><svg class='slick-arrow-icon'><use xlink:href='#arrow-right'></use></svg></button>"
    };

    $(".js-slider").on("init", function (event, slick) {
        $(slick.$slider).addClass("is-initialized");
    });

    $(window).on("load", function () {
        return $(".js-slider").slick(options);
    });
}
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(46)))
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony export (immutable) */ __webpack_exports__["a"] = closeCookiePopup;
function closeCookiePopup() {
    var $cookiePopup = $('.js-cookie');
    var isCookieAccepted = localStorage.getItem('cookieAccepted');
    if (isCookieAccepted) {
        $cookiePopup.addClass('is-accepted');
    }
    $cookiePopup.addClass('is-loaded');
    $('.js-close-cookie').on('click', function (e) {
        e.preventDefault();
        localStorage.setItem('cookieAccepted', 'true');
        $(e.target).closest($cookiePopup).stop().animate({ 'height': 0 }, 500, function () {
            $(e.target).closest($cookiePopup).css('display', 'none');
        });
    });
}
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(46)))
