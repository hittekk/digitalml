...
function bootstrap_theme_enqueue_scripts() {
	...
	if (!is_front_page()){
		...
		// slide menus
		wp_enqueue_script( 'modernizr.custom', $template_url . '/js/vendor/modernizr.custom.js', array(), null, false );
		wp_enqueue_script( 'classie', $template_url . '/js/vendor/classie.js', array(), null, true );
...
function create_post_type() {
	...
	register_post_type( 'resource-materials',
		array(
			'labels' => array(
				'name' => __( 'Resource Materials' ),
