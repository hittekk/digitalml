...
<body class="with-hero white <?=$post->post_name ?>">
  <div id="webinar_banner" class="grid-middle grid-center">
    ...
    <div class="wrapper">
        <header class="header header--gray js-burger-container" >
            <div class="main-nav main-nav--gray grid-center container">
                <div class="col-12_md-10_lg-11">
                  ...
                  <div class="logo-container menu-mobile-col">
                            <div class="logo">
                                <a href="<?= site_url() ?>">
									...
									<img id="img2" class="logo--mobile" src="<?= get_template_directory_uri() ?>/dist/images/logo-dark.svg" alt="digitalML logo white">
                                </a>
                            </div>
                        </div>
                        <div class="header-content-menu-mobile">
                            <a href="javascript:void(0);" class="burger-trigger js-burger" style="background-image:url(<?php echo get_template_directory_uri(); ?>/dist/images/icons/icon-menu-burger-dark.svg)">
			...
			<div class="grid-center-nobottom">
                <div class="col-12_md-10_lg-11">
                    <div id="secondary_nav" class="secondary-nav secondary-nav--gray">
