...
<html lang="en">
<head>
	<!-- Hotjar Tracking Code for www.digitalml.com -->
<script>
    (function(h,o,t,j,a,r){
        h.hj=h.hj||function(){(h.hj.q=h.hj.q||[]).push(arguments)};
        h._hjSettings={hjid:1043462,hjsv:6};
                                    ...
                                    <li class="menu-item   ">
                                        ...
                                        <div class="complex-menu js-header-menu-content">
                                            <div class="complex-menu-further">
                                                <h2>
													<a href="http://blog.digitalml.com/" class="link-arrowed">Blog</a></h2>
                                            </div>
                                                    ...
                                                    <div class="complex-menu-content-navs-layout">
                                                        <div class="complex-menu-content-navs-item complex-menu-content-navs-item-wide">
                                                            <div class="complex-menu-content-navs-inner">
                                                                <ul>
                                                                    <li><a href="http://blog.digitalml.com/business-strategist/">API & Service Management</a></li>
                                                                    <li><a href="http://blog.digitalml.com/enterprise-architect/">Innovation</a></li>
                                                                    <li><a href="http://blog.digitalml.com/information-architect/">IT Modernization</a></li>
                                                                    <li><a href="http://blog.digitalml.com/development-teams/">Banking & Payments</a></li>
																</ul>
                                                            </div>
                                                        </div>
                                                <div class="complex-menu-content-more">
                                                    <strong>digitalML cited in Forrester's API Design and Documentation Report</strong>
                                                    <a href="http://go.digitalml.com/forrester-API-design-report" class="button">Download the Report</a>
                                                </div>
                                            </div>
                                        </div>
