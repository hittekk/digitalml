...
<?php digitalml_get_template_part('partial-templates/section-post-actions1.php', array()); ?>
				...
				<div class="resources-cards__container container">
					...
					<div class="resources-cards__row row">
						...
						<?php while( $loop->have_posts() ) : $loop->the_post(); ?>
							...
							<?php digitalml_get_template_part('partial-templates/section-webinar--cards.php', array()); ?>
			...
			<section class="search-results results section">
				...
				<div class="search-results__container container">
					...
					<?php while( $loop->have_posts() ) : $loop->the_post(); ?>
						...
						<?php digitalml_get_template_part('partial-templates/section-webinar--results.php', array()); ?>
